function TasksBar() {
  return (
    <div className="flex flex-1">
      <aside className="flex-col bg-cyan-700 text-gray-200 py-3 px-7  min-w-[200px] w-[230px] ">
        <div className="flex flex-col items-left">
          <h1 className="text-2xl font-bold">Tasks system</h1>
        </div>
        <div className="flex flex-col items-left mt-4">
          <div className="inline-flex flex-col items-start bg-cyan-600/50 rounded-lg p-3 my-2 w-[100%]">
